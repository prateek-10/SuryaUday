{
  /* <Typography 
          ...
          >
            <div>UNLEASH GREATNESS</div>
            <div style={{ fontSize: "80px" }}>
              Elevate Your Fitness Experience
            </div>
            <Stack
              className="stack-getintouch"
              flexDirection="row"
              marginTop="40px"
            ...
            >
              ...
              {/* <img src={bar} style={{ width: '100vw', height: '1vh', backgroundColor: 'transparent', zIndex: '90', margin: '25px 0px 0px 0px' }} alt="image" /> */
}
{
  /* </Box>
      </Stack>
